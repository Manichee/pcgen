...
public class WeaponSpecialPane extends javax.swing.JPanel {
	...
	public void setColor() {
		...
		labelPanel.setBorder(new javax.swing.border.LineBorder(CharacterPanel.border));
		propPanel.setBackground(CharacterPanel.border);
		specialProperties.setBackground(CharacterPanel.bodyLight);
		specialProperties.setBorder(new javax.swing.border.LineBorder(CharacterPanel.border));
	}
