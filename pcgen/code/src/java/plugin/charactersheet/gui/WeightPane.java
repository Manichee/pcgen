...
public class WeightPane extends JPanel {
	 ...
	 */
	public void refresh() {
		light.setText(Globals.getGameModeUnitSet().displayWeightInUnitSet(new Double(WeightToken.getLoadToken("Light",pc)).doubleValue()));
		medium.setText(Globals.getGameModeUnitSet().displayWeightInUnitSet(new Double(WeightToken.getLoadToken("Medium", pc)).doubleValue()));
		heavy.setText(Globals.getGameModeUnitSet().displayWeightInUnitSet(new Double(WeightToken.getLoadToken("Heavy", pc)).doubleValue()));
		liftHead.setText(Globals.getGameModeUnitSet().displayWeightInUnitSet(new Double(WeightToken.getLoadToken("OverHead", pc)).doubleValue()));
		liftGround.setText(Globals.getGameModeUnitSet().displayWeightInUnitSet(new Double(WeightToken.getLoadToken("OffGround", pc)).doubleValue()));
		drag.setText(Globals.getGameModeUnitSet().displayWeightInUnitSet(new Double(WeightToken.getLoadToken("PushDrag", pc)).doubleValue()));
	}
