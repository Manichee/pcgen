...
public class WeaponTitlePane extends JPanel {
	...
	private void initComponents() {
		...
		titleContainerPanel.setLayout(new BoxLayout(titleContainerPanel, BoxLayout.Y_AXIS));

		weaponTitlePanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 1, 0));
		...
		currentHandPanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 1, 0));
		...
		sizePanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 1, 0));
		...
		criticalPanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 1, 0));
		...
		currentHandDataPanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 1, 0));
		...
		typeDataPanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 1, 0));
		damageType.setFont(FONT_TEN);
		damageType.setText(SPACE);
		typeDataPanel.add(damageType);
		dataContainerPanel.add(typeDataPanel);

		sizeDataPanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 1, 0));
		weaponSize.setFont(FONT_TEN);
		weaponSize.setText(SPACE);
		sizeDataPanel.add(weaponSize);
		dataContainerPanel.add(sizeDataPanel);

		criticalDataPanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.CENTER, 1, 0));
	...
	public void refresh() {
		...
		weaponTitle.setText(CharacterSheetUtils.getTitle(new StringBuffer(eq.longName()).append(eq.getAppliedName()).toString(), star, BLANK));
		weaponSubTitle.setText(CharacterSheetUtils.getSubTitle(new StringBuffer(eq.longName()).append(eq.getAppliedName()).toString()));
