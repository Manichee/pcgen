...
public class ClassSpellLevelPane extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		jPanel7.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 1, 0));
		...
		jPanel12.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 1, 0));
		...
		jPanel13.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 1, 0));
	...
	public void refresh() {
		if(serial < pc.getSerial()) {
			...
			if(!racial) {
				...
				spellList = pcclass.getSpellSupport().getCharacterSpell(null, Globals.getDefaultSpellBook(), level);
	...
	private int addLine(CharacterSpell cs, String spellBook, Color color, int gridY, List colorList) {
		...
		namePanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 1, 0));
		namePanel.setBackground(color);
		name.setFont(new java.awt.Font(DIALOG, 1, 11));
		if (si != null)
		{
			name.setText(new StringBuffer(spell.getOutputName()).append(si).toString());
		}
		else
		{
		...
		duration.setText(pc.parseSpellString(spell, spell.getDuration(), cs.getOwner()));
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 5;
		gridBagConstraints.gridy = gridY;
		gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
		...
		rangePanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 1, 0));
		rangePanel.setBackground(color);
		range.setFont(new java.awt.Font(DIALOG, 1, 10));
		range.setText(pc.getSpellRange(spell, cs.getOwner().getName(), si));
		...
		compPanel.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 1, 0));
		...
		if ((spell.getSubschool().length() > 0) && (!NONE.equals(spell.getSubschool().trim().toUpperCase()))) {
			sch.append(' ').append('(').append(spell.getSubschool()).append(')');
		}
		...
		effect.setText(
			new StringBuffer(EFFECT)
				.append(pc.parseSpellString(spell, spell.getDescription(), cs.getOwner())).toString()
		);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 1;
		gridBagConstraints.gridy = gridY;
		...
		target.setText(
			new StringBuffer(TARGET)
				.append(pc.parseSpellString(spell, spell.getTarget(), cs.getOwner())).toString()
		);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 6;
		gridBagConstraints.gridy = gridY;
